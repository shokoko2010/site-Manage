...
import { LanguageContextType, Notification } from '@/types/types';
    ...
    <div className="p-8 h-full">
      ...
      <div className="space-y-8 max-w-4xl">
        ...
        <div className="bg-gray-800 p-6 rounded-xl border border-green-500/30">
          <h2 className="text-xl font-semibold text-white mb-2">GDPR Compliance</h2>
          <p className="text-gray-400 mb-4">Configure data protection and privacy compliance settings for content generation and data handling.</p>
          <GDPRSettings onSettingsUpdate={(settings) => {
            showNotification({ message: 'GDPR settings updated successfully!', type: 'success' });
          }} />
        </div>
