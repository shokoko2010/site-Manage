...
import { GeneratedContent, WordPressSite, Notification, LanguageContextType, PublishingOptions, ContentType } from '@/types/types';
import PublishModal from './PublishModal';
import { useLanguage } from '../contexts/LanguageContext';
import { publishContent, updatePost } from '@/services/wordpressService';
import { ArticleIcon, ProductIcon, EyeIcon, ChatBubbleLeftIcon } from '@/lib/constants';
