export const translations = {
  en: {
    ...
    selectLanguagesHint: 'Select one or two languages for generation.',
    english: 'English',
    arabic: 'Arabic',
    french: 'French',
    spanish: 'Spanish',
    ...
    imageUploadSuccess: 'Image uploaded and inserted successfully!',
    ...
    professionalGenerator: 'Professional Generator (Gemini)',
    freeGenerator: 'Free Image Generator',
    professionalGeneratorHint: "High-quality, unique images generated by AI. Requires a Gemini API key.",
    freeGeneratorHint: "Fetches high-quality, royalty-free stock photos from services like Unsplash. No API key needed.",
    ...
    multipleContentsGenerated: '{{count}} new articles have been generated and saved to your library.',
  ...
  ar: {
    ...
    selectLanguagesHint: 'اختر لغة واحدة أو لغتين لتوليد المحتوى.',
    english: 'الإنجليزية',
    arabic: 'العربية',
    french: 'الفرنسية',
    spanish: 'الإسبانية',
    ...
    dropImageHere: 'اسحب الصورة هنا، أو انقر للتصفح',
    uploadingImage: 'جاري رفع الصورة...',
    imageUploadSuccess: 'تم رفع الصورة وإدراجها بنجاح!',
    imageUploadFail: 'فشل رفع الصورة.',
    ...
    professionalGenerator: 'المولد الاحترافي (Gemini)',
    freeGenerator: 'مولد الصور المجاني',
    professionalGeneratorHint: "صور فريدة وعالية الجودة مولدة بالذكاء الاصطناعي. يتطلب مفتاح API.",
    freeGeneratorHint: "يجلب صورًا عالية الجودة وخالية من حقوق الملكية من خدمات مثل Unsplash. لا يتطلب مفتاح API.",
    ...
    multipleContentsGenerated: 'تم إنشاء {{count}} مقالات جديدة وحفظها في مكتبتك.',
    ...
    advancedContentManagement: 'إدارة المحتوى المتقدمة',
    advancedContentManagementHint: 'نظم وابحث وأدر محتواك بأدوات قوية.',
    searchContent: 'ابحث في المحتوى...',
    filters: 'الفلاتر',
    ...
    versionManagementFor: 'إدارة الإصدارات لـ',
    ...
    wordCount: 'كلمات',
    unknown: 'غير معروف',
    noVersionsAvailable: 'لا توجد إصدارات متاحة بعد.',
    ...
    comparisonWithCurrent: 'المقارنة مع الإصدار الحالي',
    ...
    addTags: 'إضافة وسوم...',
    noContentFound: 'لم يتم العثور على محتوى مطابق لمعاييرك.',
    modified: 'تم التعديل',
    actions: 'الإجراءات',
    view: 'عرض',
