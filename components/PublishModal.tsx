                ...
                {content.type === ContentType.Product && (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="price" value={options.price} onChange={handleChange} className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md text-white" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium">{t('salePrice')}</label>
                            <input type="text" name="salePrice" value={options.salePrice} onChange={handleChange} className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md text-white" />
                        </div>
                    </div>
                     <div>
                        <label className="block text-sm font-medium">{t('sku')}</label>
                        <input type="text" name="sku" value={options.sku} onChange={handleChange} className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md text-white" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium">{t('stockStatus')}</label>
                        <select name="stockStatus" value={options.stockStatus} onChange={handleChange} className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md text-white">
                 ...
                 <div>
                    ...
                    <select name="status" value={options.status} onChange={handleChange} className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md text-white" disabled={isScheduled}>
                 ...
                 <div className="p-3 bg-gray-700/50 rounded-md">
                    <label className="flex items-center cursor-pointer">
                        <input type="checkbox" checked={isScheduled} onChange={e => setIsScheduled(e.target.checked)} className="h-4 w-4 rounded border-gray-500 text-blue-600 focus:ring-blue-500 bg-gray-700" />
                    ...
                    {isScheduled && (
                        <input 
                            ...
                            className="mt-2 block w-full bg-gray-600 border-gray-500 rounded-md text-white"
                        />
                    )}
                </div>
