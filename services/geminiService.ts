  ...
  siteContext?: SiteContext
    ...
    **ARTICLE SPECIFICATIONS (apply to both language versions):**
    ...
    try {
        ...
        return parsedArray.map((parsed, index) => {
            if (!parsed.title || !parsed.metaDescription || !parsed.body) {
